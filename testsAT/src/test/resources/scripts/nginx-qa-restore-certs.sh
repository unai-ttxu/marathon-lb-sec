...
bash -e gencerts -l /stratio_volume/certs_restore_nginx-qa.list -w -v vault.service.$INTERNAL_DOMAIN -o 8200 -t $VAULT_TOKEN -d $INTERNAL_DOMAIN -c $CONSUL_DATACENTER -p ${pki_password:-stratio}